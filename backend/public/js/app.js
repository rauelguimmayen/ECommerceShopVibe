...
function renderNavUser() {
  ...
  if (user) {
    const adminLink = user.role === 'admin'
      ? `<li><a class="dropdown-item" href="/pages/admin/dashboard.html"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a></li><li><a class="dropdown-item" href="/pages/admin/webhooks.html"><i class="bi bi-broadcast me-2"></i>Webhooks</a></li><li><hr class="dropdown-divider"></li>`
      : '';
    navUser.innerHTML = `
